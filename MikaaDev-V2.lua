...
local DAMAGE_MULTIPLIER = 10     -- Ubah angka ini untuk perkalian damage (contoh: 1000 = 1000x damage)
local DAMAGE_VALUE = 20          -- Ubah angka ini untuk damage tetap (contoh: 9999 = langsung kill)
